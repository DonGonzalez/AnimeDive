...
extension AnimeTableView: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.config(title: self.data.data[indexPath.row].attributes.canonicalTitle, numberOfSeason: data.data[indexPath.row].attributes.episodeCount, imageUrl: URL(string: data.data[indexPath.row].attributes.posterImage.tiny)!)
        return cell
    }
}
